...
class Store                                                  // base class Store
{
	...
	public:
		...
		friend void display(Store & obj);                    // prototyping for friend function having taking class object as argument		
};

void display(Store &obj)                                    // friend function definition to display data taking address of object of base class
{
...
int main()
{
	...
	//displaying items for store 4,5 using friend function display           
	cout<<"\nDisplaying Items of Store 4(Stationary) using Friend Function Display() :- ";
	// Displaying 3 items for store 4 using base class object obj4
	display(obj4);                                      
	cout<<"\nDisplaying Items of Store 5(Food) using Friend Function Display() :- ";
	// Displaying 3 items for store 5 using base class object obj5
	display(obj5);                                     
	return 0;
}
